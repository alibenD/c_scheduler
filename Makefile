...
# @create_date: 2018-06-08 22:24:09
...
#VARIABLE
  ...
  #SOURCE_LIST
    ...
    TEST_LIST=test_dispatch.c test_scheduler.c
    OBJECT_LIST=scheduler.o

  #FILE_LIST
    SOURCE_FILE_LIST=./src/scheduler.c
    INCLUDE_FILE_LIST=./include/scheduler.h
    TEST_FILE_LIST=./test/test_dispatch.c ./test/test_scheduler.c
    OBJECT_BUILD_FILE_LIST=./build/obj/*.o
...
#---This field should be set while you created your program
  #TARGET_LIST
    ...
    TEST_OBJECT_LIST=test_dispatch.o test_scheduler.o
    TARGET_BIN_LIST=
    TEST_BIN_LIST=test_dispatch test_scheduler
